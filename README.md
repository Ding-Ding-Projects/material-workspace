...
| Check | Result |
| --- | --- |
| Unit and engine suite | **1,093 tests**, 51 files |
| Driven against the real build | 13 drivers, **399 checks** |
...
| Feature inventory | **81 of 82** contracts built, the one gap named |
