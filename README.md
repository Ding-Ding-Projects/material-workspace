...
| Check | Result |
| --- | --- |
| Unit and engine suite | **1,031 tests**, 49 files |
| Driven against the real build | 13 drivers, **378 checks** |
...
| Feature inventory | **74 of 75** contracts built, the one gap named |
