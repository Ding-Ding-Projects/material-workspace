...
| Check | Result |
| --- | --- |
| Unit and engine suite | **1,062 tests**, 50 files |
| Driven against the real build | 13 drivers, **384 checks** |
...
| Feature inventory | **77 of 78** contracts built, the one gap named |
